...
-- [TRIGGER 1] Auto-generate Nomor Rekam Medis
DELIMITER $$
...
-- [TRIGGER 2] Sinkronisasi Status Tagihan
DELIMITER $$
...
-- [TRIGGER 3] Validasi Jadwal Dokter (Mencegah Overlap)
DELIMITER $$
...
-- [TRIGGER 4] Audit Trail Logging Rekam Medis
DELIMITER $$
...
-- [TRIGGER 5] Auto-Update Stok (Metode FEFO)
DELIMITER $$
...
-- [TRIGGER 6] Validasi Stok Obat Tidak Boleh Negatif
DELIMITER $$
...
INSERT INTO Pasien (nama, tgl_lahir, nik, jenis_kelamin) VALUES ('Dedi Duplikat', '1990-05-17', '3515011705900003', 'L'); 
...
INSERT INTO Transaksi_Stok (tanggal, jenis_transaksi, jumlah, referensi, keterangan, batch_id, lokasi_id)
VALUES (NOW(), 'Stok Keluar', -9999, 'TEST-MANUAL', 'Uji Paksa Minus', 1, 1); 
...
INSERT INTO detail_tagihan (tagihan_id, jenis_item, harga_satuan) VALUES (1, 'Konsultasi Mandiri', 150000.00); 
SELECT tagihan_id, tanggal_tagihan, status, total_biaya FROM tagihan WHERE tagihan_id = 1; 
INSERT INTO detail_tagihan (tagihan_id, jenis_item, harga_satuan) VALUES (9999, 'Tindakan Tanpa Kuitansi Induk', 75000.00); 
...
INSERT INTO kunjungan (patient_id, tgl_kunjungan, waktu_datang, status, jenis_layanan) VALUES (1, '2026-06-17', '2026-06-25 13:00:00', 'Menunggu', 'Umum'); 
SELECT k.visit_id, p.nama, k.waktu_datang FROM kunjungan k JOIN pasien p ON k.patient_id = p.patient_id WHERE k.waktu_datang = '2026-06-25 13:00:00'; 
INSERT INTO kunjungan (patient_id, tgl_kunjungan, waktu_datang, status, jenis_layanan) VALUES (2, '2026-06-17', '2026-06-25 13:00:00', 'Menunggu', 'Umum');