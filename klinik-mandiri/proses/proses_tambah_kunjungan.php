...
// Tangkap parameter aksi untuk membedakan Tambah atau Hapus
$aksi = isset($_GET['aksi']) ? trim($_GET['aksi']) : '';

// =========================================================================
// OPSI 1: AKSI HAPUS PASIEN (Diakses via GET dari link tombol hapus)
// =========================================================================
if ($aksi === 'hapus') {
    ...
    try {
        ...
        echo "<script>
                alert('Sukses: Data pasien berhasil dihapus dari sistem!');
        ...
        echo "<script>
                alert('Error Database: " . addslashes($e->getMessage()) . "');
                window.location.href = '../views/pasien.php';
              </script>";
        exit();
    }
...
// =========================================================================
// OPSI 2: AKSI TAMBAH PASIEN BARU (Diakses via POST dari Modal Form)
// =========================================================================
